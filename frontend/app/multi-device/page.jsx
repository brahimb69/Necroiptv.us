...
import { FaCheck, FaCrown, FaDesktop, FaLaptop, FaMobileAlt, FaTabletAlt, FaTv } from "react-icons/fa";
      ...
      <div className="container relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground dark:text-foreground-dark/70 max-w-2xl mx-auto">
            Get access to premium entertainment with our flexible subscription plans. All plans include full access to our premium features.
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          <button
            onClick={() => setActiveDeviceCount(1)}
        ...
        <div className="mt-12 text-center">
          <p className="text-sm text-muted-foreground dark:text-foreground-dark/70">
            *All prices are in USD. No additional taxes.
            <br />
            Subscription doesn't auto-renew, you have to manually renew.
          </p>
        </div>
      </div>
    </section>
...
export default MultiDevicePricing;
